...
class AuthControllerTest {
    ...
    void registerPatient_returnsCreatedWithEnvelope() throws Exception {
        UserDto userDto = new UserDto(1L, "pat@example.com", "Pat", Role.PATIENT, false, null, null, null, false);
        AuthResponse auth =
                AuthResponse.of(
                        "access",
                        "refresh",
    ...
    void login_returnsOkWithEnvelope() throws Exception {
        UserDto userDto = new UserDto(1L, "u@example.com", "U", Role.PATIENT, true, null, null, null, false);
        AuthResponse auth =
                AuthResponse.of(
                        "a",
                        "r",
    ...
    void registerDoctor_multipart_returnsCreated() throws Exception {
        UserDto userDto =
                new UserDto(2L, "doc@example.com", "Doc", Role.DOCTOR, false, null, null, null, false);
        AuthResponse auth =
                AuthResponse.of(
                        "da",
                        "dr",
